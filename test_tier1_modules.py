...
async def main():
    ...
    try:
        ...
        print("SUMMARY")
        print("="*60)
        print(f"  ConversationMemory: {'✅ PASSED' if test1 else '❌ FAILED'}")
        print(f"  SentimentAnalyzer: {'✅ PASSED' if test2 else '❌ FAILED'}")
        print(f"  Smart Retry Logic: {'✅ PASSED' if test3 else '❌ FAILED'}")
